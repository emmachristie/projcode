...
class UserSportsControllerTest < ActionController::TestCase
  ...
  test "should create user_sport" do
    assert_difference('UserSport.count') do
      post :create, user_sport: { sport: @user_sport.sport, user_id: @user_sport.user_id, user_name: @user_sport.user_name }
    end
  ...
  test "should update user_sport" do
    patch :update, id: @user_sport, user_sport: { sport: @user_sport.sport, user_id: @user_sport.user_id, user_name: @user_sport.user_name }
    assert_redirected_to user_sport_path(assigns(:user_sport))
  end
