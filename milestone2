...
A few things need to be fixed in addition. When showing people in your area, self shouldnt show up. The find me button should use the lat and long it produces to get a location for the user without them having to type that in themselves. Also a lot of styling.
